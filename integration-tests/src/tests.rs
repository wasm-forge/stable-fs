...
async fn check_metadata_binary() {
    ...
    assert_eq!(
        &bin,
        "030000000000000004fafafafafafafa06000000000000000800000000000000410000000000000042000000000000004300000000000000fafafafafafafafafafafafafafafafa02fafafafafafafa0100000000000000abcd000000000000"
    );
}
